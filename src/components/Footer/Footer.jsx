  ...
  return (
    <footer className=" bg-blue shadow">
      <div className=" mx-auto p-4 md:py-8">
        ...
        <img src={instagram} alt="" className="w-12 h-12 md:hidden opacity-60 hover:opacity-100" />
        <img src={linkedin} alt="" className="w-12 h-12 md:hidden opacity-60 hover:opacity-100" />
        </div>

        </div>
        <hr className="my-6 sm:mx-auto border-gray-400 lg:my-8 " />
        <div className="flex lg:justify-between items-center lg:px-10">
          <span className=" block text-lg text-white text-center font-extralight ">
            {" "}
          ...
          <a href="https://www.instagram.com/thehextechstudios/">
            <img src={instagram} alt="" className="w-12 cursor-pointer opacity-60 hover:opacity-100" />
          </a>  
          <a href="https://www.linkedin.com/company/98518178/admin/feed/posts/">
            <img src={linkedin} alt="" className="w-12 cursor-pointer opacity-60 hover:opacity-100" />
          </a>
          </div>
        </div>
      </div>
